...
class Shape2D(mesh: FloatArray) {
    ...
    private var vertexBuffer: FloatBuffer =
        ...
        ByteBuffer.allocateDirect(mesh.size * Float.SIZE_BYTES).run {
    ...
    private val vertexCount: Int = mesh.size / COORDINATES_PER_VERTEX
    private val vertexStride: Int = COORDINATES_PER_VERTEX * Float.SIZE_BYTES

    fun draw(projection: FloatArray) {
